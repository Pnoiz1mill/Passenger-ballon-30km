...
void setup() {
  ...
  // Configuration for the GNSS module
  ...
  // myGNSS.saveConfiguration(UBLOX_CUSTOM_MAX_WAIT);  // (For saving to module's flash memory, optional)
}
...
void loop() {
  ...
  if (myGNSS.getPVT() == true) {
    ...
    int32_t altitude = myGNSS.getAltitudeMSL()/1000; // Altitude above Mean Sea Level
    Serial.print(F(" Alt: "));
